...
import ModalBox from "./EditProfile.js";
...
const ProfileModule = () => {
    ...
    if (isConfirmed) {
      try {
        const response = await axios.delete(
          `${BASE_API_URL}profiles/multiDelete`,
          {
  ...
  //         // Set timeout to close the form after 2 seconds (2000 milliseconds)
  //         setTimeout(() => {
    ...
    if (isConfirmed) {
      ...
      try {
        ...
        const response = axios.delete(
          `${BASE_API_URL}profiles/delete?id=${id}`
        );
      ...
      <div class="main">
        ...
        <div class="main2">
          ...
          <div class="allcontent">
            <div class="welcome">
              <h2 className="headerData">Welcome To Profile Page</h2>
            </div>
